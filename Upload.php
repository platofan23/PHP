...
?>
<!-- Formular mit Aktion zur Upload machen -->
<form action="Upload_Machen.php" method="post" style=" background-color:white;" enctype="multipart/form-data">
	<!-- Div zum stylen -->
		<div class="row">
			<div class="col-25">
				<label for="fname">Datei</label>
			</div>
			<div class="col-75">
