...
?>
<!-- Fomular mit Weiterleitung zu Download machen -->
<form action="Download_Machen.php" style="background-color:white;" method="post">
    <div class="row">
        <!-- Div zum stylen -->
        <div class="col-25">
        ...
        <div class="col-75">
            <input type=text name="datei" required>
        </div>
    </div>
    <div class="row">
        <div class="col-25">
